 ...
 *   functions-enricher.php        — Term and Person property builders from WordPress data
 *   definitions/                  — Schema structure definitions (one file per context/post-type)
 *   mappings/                     — Term and Person mapping data files
 *
 * @package Fralenuvole
 */
...
require_once FRL_DIR_PATH . 'public/schema/functions-enricher.php';
